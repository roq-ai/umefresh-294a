...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`umefresh`}</title>

        <meta
          name="description"
          content="Welcome to umefresh - Your ultimate online shopping destination, bringing you the freshest products at your fingertips, anytime, anywhere."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1563013544-824ae1b704d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMkJzaG9wcGluZ3xlbnwwfHx8fDE2OTgzMjc3NjN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to umefresh - Your ultimate online shopping destination, bringing you the freshest products at your fingertips, anytime, anywhere.`}
            </Text>
            <Box
